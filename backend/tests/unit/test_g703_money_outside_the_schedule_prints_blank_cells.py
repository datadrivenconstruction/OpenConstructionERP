...
a non-zero G and column H read minus G. The founder settled it: those three
cells are empty. An empty cell says there is no answer; a zero says the answer
is zero. Everything else on the row, and every figure on the G702 face, stays
exactly as it was.
