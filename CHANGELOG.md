...
## [0.1.1](https://github.com/datadrivenconstruction/OpenConstructionERP/compare/v0.1.0...v0.1.1) (2026-04-25)


### Features

* /chat respects site theme + rich empty state + i18n (v1.3.5) ([5e4d1c8](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/5e4d1c81aba960a468db30856cd8bb3262c455ce))
* 3 demo showcase projects (DE/EN/ES) + IFC/RVT-only upload options ([507c7c2](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/507c7c240038905e2657328ae3f51f8c0b91a6db))
* 3-tier conversion depth (Fast / Standard / Full) ([33bd349](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/33bd349b6b5dfe25668cdafde7b90bdedc28bf2c))
* add 60 missing translation keys × 21 languages (1,281 lines) ([5439137](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/5439137bf44bf03584311a7c88cc81d42d7e0794))
* add Markups & Annotations module + Punch List module (20 modules total) ([c9d2d17](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/c9d2d17e94a9506700abac56a4f6629e285b8bbd))
* add parallel upload hint to BIM processing overlay ([2e5e7aa](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/2e5e7aa5753562d38bbad19ab1dc025a84e45ade))
* add Privacy Policy + Terms of Service pages ([8a8dc61](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/8a8dc614bbe546c0cceae93702a8f8eacc5d1ce5))
* add v1.0.0 changelog entry ([2c8c06d](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/2c8c06da8bfb967ae472c3983addc9447cc3eb8c))
* AI Chat module + BIM redesign + UX improvements (v1.3.0) ([2695256](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/2695256a035377c683691197842d5871da5b847a))
* AI meeting summary — structured prompt, preview mode, 3-step import ([f857f99](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/f857f995eecf6db7c2ddcb9899c966cbf9fb04b7))
* AI tools toggle in onboarding wizard + project-intelligence module in AI group ([32df1b6](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/32df1b6078a644e259cfdbc69c969ef2dcc15774))
* API docs, performance optimization, frontend accessibility ([d899f87](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/d899f872eb5c931a00dbedf7bb83c0f3a64e5c70))
* auto-export PDF sheets from Revit/IFC to Documents module ([638571d](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/638571dcfd4a7e2781e7be52d9999c3b1c0c1b8e))
* BIM advanced UX — auto-zoom, shortcuts, dark mode, CSV export, model summary ([4611516](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/461151698927491e8d34cf5613471b58ed05fe01))
* BIM deep quality — mesh matching fix + requirements validation ([2a41e5b](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/2a41e5b615e41081f94ddb58a08a8b4ccd572af2))
* BIM groups + saved-snapshot UX, takeoff stale-chunk recovery, docs YouTube links ([ef37433](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/ef37433273138f6740622d2484706c9dd5f381a8))
* BIM Groups Panel + BOQ ↔ BIM 3D navigation ([47dcef7](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/47dcef7d38ba3a40719de42be0deef636cca2602))
* BIM inline converter install — no navigation, one-click install with spinner ([c8277d2](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/c8277d21ba4ac90685796f33ca4d424f3fc9e0a4))
* BIM integration hardening — auto-quantity, all-props panel, wireframe, model cards ([6c3f365](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/6c3f3654c54b2e6c590699b19d95e8a305f19d72))
* BIM link preview, polyline measurements, DWG viewport fix, UI improvements ([a9992cd](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/a9992cd5f18f1c84b2edf5f983b83ae08173fe8a))
* BIM processing shows converter module install cards (DDC cad2data IFC/RVT) ([e1e3ae8](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/e1e3ae8ec7177cdb350f7de8388cba4f3f3c21e1))
* BIM processing status + 12-module demo data for 5 projects ([9ca0d83](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/9ca0d839bdfb4a5d995fa69b776ae03a78bc572d))
* BIM requirements import/export + background upload + README fix ([571667d](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/571667de44d2d97ecb7c156a2daba713f4f10582))
* BIM viewer filter + group panel (Pass 1 of 3) v1.3.8 ([30139b1](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/30139b19ac540af698c15fe3a5c38d4fdfa0c948))
* **bim:** upload workflow with CSV/Excel data + DAE geometry ([970877c](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/970877c71f0a1ee43b2b141e933b7272200231f0))
* BOQ regression tests, export quality, stats for 5 modules ([c4c690c](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/c4c690c20186bb58a710f0e4d033f3b2a0341bdd))
* **boq:** professional BOQ features — Custom Columns + Renumber + Excel round-trip ([49c6940](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/49c6940578931591347916eae03adedab3b43360))
* CAD classification auto-mapping + IFC QTO presets + classify endpoint ([408455d](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/408455ddcaf322dea64562e0d6ee6f544073c8eb))
* CAD Data Explorer module + sidebar reorganization + progress bar ([a5c3eab](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/a5c3eab172eadc44b5fda4dbb8a3f762a07da4f6))
* CAD Takeoff — persistent sessions (24h), Create BOQ, Excel export ([30c2e72](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/30c2e720df611429ef91cb58dcf384810f1f455d))
* CAD Takeoff UX — tree view, element detail panel, column confidence ([756adc2](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/756adc238fb10c830dacd8fb05992ae890dd6c83))
* CAD-BIM Explorer — inline file upload, progress bar, converter status ([0ae993c](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/0ae993ceef26d25e453b30cc83a997adc428bbbd))
* CAD/BIM module improvements — navigation, Create BOQ from Pivot, export with resources ([52568ac](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/52568ac066e254d4590d913bacd8cd69c273a7f7))
* centered upload progress overlay with ETA on /bim ([5f816ba](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/5f816bac6d96e80f2461a120422114173b956ca6))
* clickable Type Names in filter panel — filter by individual types ([49ea328](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/49ea328aa4769b13313f8e76eb1d28467315fa85))
* complete all remaining plan items — schedule import, reporting dashboards, weather, takeoff save ([3875370](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/38753702f3092035b227df109ca6d0eca619dfb5))
* **compliance:** accessibility, GDPR RoPA template, SOC 2 readiness ([5f51db2](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/5f51db26355fe64d34e1e2626078666ec4ec4e97))
* cross-module integration — pin-to-plan, document links, project dashboard ([fb86471](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/fb864716aec0da1333a9f34de496bc28e3a6bf2d))
* cross-module interconnect fixes — NCR variation, meeting→tasks nav ([b9cead8](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/b9cead80f29f2f7a22cff2e129e6d20aaae21473))
* cross-module links + visual create forms for 5 modules ([5a1ecad](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/5a1ecad2cfef97e91c3faec3ecce82bc580136b9))
* Custom Columns in BOQ — dynamic user-defined columns stored in metadata ([a01439c](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/a01439ce7846d53766127337fae8410fec0fc6b0))
* dashboard workflow guide + system status + tooltips + UX writing improvements ([46ccfd1](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/46ccfd11c8702386fe3547f6e98281d70335e7d4))
* **dashboards:** T00 Phase 0 — module scaffolding + core primitives ([5bb168a](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/5bb168abba2c41c253baf053560bd4421f316772))
* Data Explorer — deep UX improvements ([3050f6b](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/3050f6b7425402a5fc010e98d57f764ecbd44eb1))
* Data Explorer — global search, export CSV, column picker, data quality ([1261eb8](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/1261eb8ac47cf2b82fc3dca7f88feaccddd2186f))
* Data Explorer heatmap + pivot export, i18n fixes, quality polish ([04fa7d6](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/04fa7d69ac00b127896f9a00881102431625565a))
* Data Explorer landing page — professional card grid for recent models ([59fd9e8](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/59fd9e828590008f0a79be9ae7886d1b9182e297))
* Data Explorer professional landing + BIM layout fix + delete model ([3943042](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/3943042a2ea2b603895975d2e0ab5f366f8a7c79))
* data integrity, frontend polish, complete i18n DE/RU ([9e71dff](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/9e71dffb8c6085d8e8ca8bb812f71f49f0061a28))
* DDC cad2data IFC + RVT converter modules in Modules marketplace ([cacf7ba](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/cacf7babaaea06e3a2e0ea1ec33c33fa17190d9d))
* DDC DWG Excel parser — real 2D geometry from DwgExporter ([66ef76d](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/66ef76df673232a80f226dddaec60c7419467892))
* deep audit fixes — EVM forecast, CPM metadata, cascade cleanup, events (v1.3.2) ([b2f298d](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/b2f298d78bce36e9d2d56a49e701c518f30a30a0))
* deep audit v2 — 17 stats endpoints + BOQ improvements + finance dashboard ([6452dda](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/6452ddad9721a076fed2485b6c22775029f4a351))
* deep UX improvements across 7 pages — search, empty states, reports, modules ([5c19198](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/5c19198cda1ae78b33ec67d7dba4207266116f2f))
* delete sessions from Data Explorer landing + show 12 recent instead of 6 ([2912a8d](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/2912a8da6bdf66de52574142117c6535ee99e075))
* document uploads now run in background via global queue ([05c7388](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/05c7388e1b54e77c167d2835dd80e7247709ca59))
* DWG Takeoff module — 2D drawing viewer with measurements & annotations ([26f900b](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/26f900bd044c9eddcff761ee907e253ea18ec8aa))
* **eac:** EAC v2 block-editor primitives — Selector/Logic/Attribute/Constraint/Triplet/Variable blocks + palette + demo route ([cf7c0d5](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/cf7c0d5addc7737bfb32f6c5d5d29bef7ac821b4))
* Excel Round-Trip foundation — import metadata preservation for re-export ([3170d06](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/3170d067c456843ec939ae7ceaa9db4c42977faf))
* Field Reports + Photos translations — 42 keys × 21 languages (882 lines) ([e848c8a](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/e848c8af559831343cb76cd3147338a94a4a4dd7))
* field reports import/export + sidebar reorganization ([a97f203](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/a97f203a7e296ed63b62129434b7f8d5635b1185))
* Field Reports module (21st module) — daily logs, weather, workforce, PDF export ([8221316](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/8221316437fbfdaa134ca0c5738d46a23b8ec07e))
* floating progress bar for background DB loading ([35dd4af](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/35dd4aff40145663e023930f23799deb08638f5a))
* **frontend:** 7 pages + CommentThread + inter-module events ([058e18a](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/058e18a5f5522773e4b8a05e66801d8da91e75a6))
* **frontend:** notification bell, regional settings, 6 new pages ([ea83fc3](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/ea83fc3fd113ab7a9b73f2746b3e1b904f6efb34))
* full-width BIM + Chat pages, RVT/IFC-aware filters, site-theme chat (v1.3.11) ([7035fc5](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/7035fc5fe80bceb1bf4160d5e7cbbd74c611baa4))
* Gantt chart, BIM Viewer, i18n keys, integration tests ([e01bddc](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/e01bddc10ca2a4908a739b1c91a2717f110d772e))
* global upload queue with header indicator ([4437cc1](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/4437cc1fb3942d85d7c3baab4fe401dfac1337a7))
* Google Analytics (G-JYQXK2652T) + comprehensive SEO optimization ([135d234](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/135d234d593d4ab61b7a808e5d6788f2ca741996))
* Hierarchical BOQ foundation — multi-level sections + recursive tree builder ([be1bc7a](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/be1bc7ae6a9dd7646b8e788fc42fe5c55d7f69cd))
* hover tooltip, tabbed properties panel, keyboard shortcut overlay ([d793a12](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/d793a12b184006acd8d10bc3ef693e83a0d7bff3))
* **i18n:** Phase 9 — internationalization foundation (sub-phases 9.1 + 9.2) ([24b4f08](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/24b4f08bb6b0ce91a6cea9968c7fd2ac3201c9a0))
* **i18n:** Phase 9.3+9.4 — user preferences + locale-aware components ([b194980](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/b19498045b8e0bba65e4b94234ccc9f79fff3ec5))
* IFC demo file generator for realistic BIM sample models ([2c7aa5f](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/2c7aa5f2edde375116ef4fde4b2e9c306dee5868))
* IFC4x3 civil infrastructure support (issue [#52](https://github.com/datadrivenconstruction/OpenConstructionERP/issues/52)) ([cfe021f](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/cfe021fbed1b5204a98f1d840db90ee8564f69e4))
* import/export for contacts, tasks, finance, safety, inspections, RFI, meetings ([6d602ac](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/6d602ac632bc4fc384b205255e597f4286716b11))
* **infra:** Phase 11.1-11.5 — contacts, audit, notifications, collaboration, teams ([d5a5d10](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/d5a5d1067d0214c0b57a9c15dfd41f756a124f6a))
* **infra:** Phase 11.6-11.9 — meetings, CDE, transmittals, OpenCDE API ([6a2ae30](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/6a2ae3054fa907f828966dfcd8a4d3a09138a814))
* integrate upload queue — CAD conversion runs in background with header indicator ([41f4d05](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/41f4d05ea54e9775b41ace486627d2fae960c754))
* integrations module — webhooks, email, calendar, Teams, Slack, Telegram ([40cc3f4](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/40cc3f419de78edb071a2e9e34356d1d499e9b07))
* integrations setup instructions + inactive cards + test connection ([765d6b2](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/765d6b2c2cd1cb88a5fd7949d5ebe4a1c09b79f1))
* INTERCONNECT Phase 1-4 — utility depth, shared infra, cross-module tests ([9cee72b](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/9cee72b1bb2e041c9aeb1c59dbbcac17b605854a))
* keyboard shortcuts (n=create, s=save in BOQ, g+m/i/o navigation) + UX writing ([d03ff80](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/d03ff8045b239fe32cb1106749376f23df59004e))
* **legal:** add CODEOWNERS refresh, patent and trademark policies ([287b1a1](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/287b1a1f1ced095ad549be8c6f928b74fc5fb804))
* **legal:** CLA v2 - preserve dual-licensing and successor-entity rights ([fc820ce](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/fc820ce5f1ee0f511a72338c7012ba77f474ca83))
* markups — 'Annotate on PDF' button links to TakeoffViewer, document hint when empty ([d033f11](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/d033f11eaeba63e810255c2dd5fa825d2f4d6bd9))
* Markups & Punch List frontend pages with routes and sidebar ([8fff970](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/8fff9701c2c6db190b28e0fbb684c29a7c32f447))
* Markups + Punch List translations for all 21 languages ([cd70f8b](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/cd70f8bb69d8a2fd0ea2a715cbf9a792a824bb74))
* modal-based creation for BOQ, Projects, Assemblies + UX improvements (v0.4) ([2c9f9b2](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/2c9f9b2a935aa721d37d6d968633bf67c5c0beff))
* **modules:** Phase 10 — Module System v2 with enable/disable + persistence ([0e9a9d5](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/0e9a9d5908d297cca72b68cf3828d7ef94a72146))
* multi-select + right-click context menu + hide/isolate ([3eecd64](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/3eecd64fad40e591c4d576ee5188aaff9abc723d))
* **observability:** v2.4.0 slice C — structured error logging + storage fallback ([b00c0c8](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/b00c0c803d4195f9effb90b8d37d3c2631c4dab5))
* onboarding wizard with 5 company presets + module selection ([a52c183](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/a52c183bc232d9094df6ec8858a82fc13fa7e3b6))
* Parametric Assembly formula engine — variables, conditionals, lookups ([6c6d843](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/6c6d843e54ac94f92ab3ec774581f15e946bc60f))
* Parquet + DuckDB analytical dataframe for BIM elements ([f953324](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/f95332460dbd7b16a8dfcda35427b9009396a47f))
* Pass 1 — bulk ops + search + task dependencies (v1.3.3) ([87867d5](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/87867d5598fde4533b9fd809b70cf49e391b21ad))
* PCI module (collector+scorer+router), sidebar cleanup, BIM fixes ([259dabb](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/259dabb21a64ea3602d3a31c32c8686c83c90cf4))
* PDF annotation tools integrated into TakeoffViewer — unified measurement + markup ([0c37fbe](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/0c37fbe11253f3b2d341917a00ff50335cb0e5f3))
* PDF takeoff — server sync, Documents integration, professional workflow ([5498fcf](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/5498fcf1dfc89c92135a87fa59ed015b35ff7fe2))
* PDF Takeoff Phase 1 — Polyline, Volume, Groups, Excel export ([7dfabea](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/7dfabea0143201210b0374460c25c30dec31fc29))
* persistent CAD analyses — save to project, list, reopen, delete ([430435d](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/430435dd2b542b31adc51ce90d433758c43d42e4))
* Phase 3 — lazy loading by group (server-side filtering) ([08bfbb5](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/08bfbb5a7b04625f53c2e72a6d811654c2f13a17))
* Phase 4 — cross-module 'View in BIM 3D' navigation ([1826018](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/1826018d34d786bc9ba36dd912a818e670b05f25))
* Phases 12-16 — Projects/BOQ/Schedule/Finance/Field/Variations ([7ed126f](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/7ed126f154db044223e8d57ed9c5d510595bd943))
* Phases 17-19 — Documents polish, BIM Hub, Reporting ([82aa5a1](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/82aa5a1b8bc4ec3ddf1969b3f9a1adc19aa2cecd))
* Phases 20-22 — regional packs, enterprise packs, release polish ([f331b3b](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/f331b3b957504fb75209e9d01bf47b1ab157a26e))
* Photo Gallery — upload, EXIF, GPS, categories, lightbox, timeline ([811d442](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/811d4423a50f1763c6ec4330f15c2f49ffa7d053))
* Photos translations all 21 languages (20 keys × 21 = 420 lines) ([7715ad7](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/7715ad7e85e08acbfd711082d94f59603c32710b))
* professional export formatting — Excel header block, PDF cover page with signatures ([49e7de9](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/49e7de9487f5e36486ee2793350b3ff62ef039a0))
* professional resource-position pricing logic + dynamic column alignment ([7324c35](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/7324c3522f7aa86fd01811c661e568a1ed041c31))
* redesign BIM filter pipeline — skip junk, key properties, quantities ([c51429a](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/c51429a0b003eac01ddbd68e97b368eaf3f3a727))
* redesign Modules page — 3 tabs with company profiles ([7f087dd](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/7f087dd8450bc2a4c5e1f7b15be3fdb0b8a9952e))
* redesign onboarding wizard — DokuFluss-style industry profiles ([ae7eb64](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/ae7eb643c5e416d35e767c59468716cc1b175e8d))
* Requirements & Quality Gates module (EAC triplets) + fix SPA fallback ([9cceb44](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/9cceb449ee2233ee2f63208ca27045f7353864fa))
* requirements export (CSV/Excel/JSON) + import (CSV/JSON) + regex validation ([4e591b8](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/4e591b8ed1dea79e43d0198786a664c50f210d58))
* requirements translations for all 21 languages ([e01aec9](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/e01aec998622263f99dfeddb41d02259827f5eb4))
* resource quantities scale proportionally when position quantity changes ([d6f4447](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/d6f4447d2c2fbae0745e33168813bda2274aa983))
* schedule baselines/progress, field logs, BOQ lock UI, risk matrix ([189b4ae](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/189b4ae05dbde4315f89a8a8f24facb81bcf629b))
* **security:** password policy + login rate limit + JWT freshness + security headers + input validation ([2c4c083](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/2c4c0835235e16478a9868fdbf0d8a10450f8f95))
* Sheet Management — auto-split PDF, OCR detection, disciplines, version control ([27a6e8b](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/27a6e8bc310b5a5ae1baf004189f95eaefa97906))
* show saved CAD models in Documents page + breadcrumb link ([09a9eb9](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/09a9eb94306100c2b830fd637e112eb81a70c9f0))
* smart UX — next steps, recent items, form validation, mobile, API quality ([ab219b4](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/ab219b4c6d958b60d58674e7fb5090e4fa1227a0))
* split PDF Takeoff into two sidebar menus — Measurements + Documents & AI ([9859a70](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/9859a704683d1ec9ff95406f6b7c31318a5e03ad))
* Takeoff measurement persistence — TakeoffMeasurement model + 9 endpoints ([ad482b0](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/ad482b0fb0a2d9cb8dc57e26183ee986ab573df9))
* Tasks — custom Kanban columns + real drag-drop board ([ce232d7](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/ce232d73af9082de9cc0e7a2fb4c138a3875ad83))
* unified project dashboard, cross-module flows, global search, activity feed ([52666ff](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/52666ff9a91589cbfe49ff16bf197549dda31f17))
* **update:** compact card + single How-to-update button with install modal ([585f76d](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/585f76d3f70a6bbb923ace71ce70c0d07be5f9c0))
* **update:** compact sidebar card opens full-screen modal on click ([a3b1749](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/a3b1749cc7ee1bc144eb642c515bb650affa3fee))
* **update:** full-page modal popup instead of sidebar card ([257f22c](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/257f22c0b3dc5c0cc2f8d4ea8bb60da85f298a0d))
* user-selectable conversion depth (Standard / Complete) ([5d061a8](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/5d061a8b234ca42eb22f2a715305607933fba037))
* UserSearchInput in forms, doc-hub crosslinks, Swagger UI fix, ODA removal ([0328b12](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/0328b12995a62f59838b889aed3ac28bc1945cf5))
* UX improvements — Quick Start, simplified sidebar, always-visible actions ([f6cd2e8](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/f6cd2e893f795dc4e8fa965b4cdc53069f0dcc63))
* UX polish — new position highlight, project breadcrumb, mobile scroll lock ([72191b0](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/72191b057aabcb899ff56b1644b29cf0e313f950))
* UX polish + migration scripts + Alembic v0.9.0 ([7567d58](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/7567d58ab4ff84ef6fd386d48e989cd1dc6b0ca3))
* UX writing — improved texts, subtitles, toasts, empty states across 14 files ([4480fea](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/4480fea007c32367bad4e87c395599e6a00bcd8f))
* **ux:** brand-blue update card, markdown parsing, multi-scheme renumber ([a095654](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/a095654c5d2b07db252d649f53dbf01676836556))
* **ux:** friendly error messages + Project Health bar + Continue your work + a11y polish ([10b9484](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/10b9484e16fa081e096204689114d0fcffcbf337))
* v0.9.1 — 14 integrations, Discord/WhatsApp, UX visual polish ([97ed77e](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/97ed77e4a97cf6e36ebf435eb23da65a85621abe))
* v1.0.0 — interconnected module ecosystems + visual forms + cross-links ([4741dc1](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/4741dc1966e1c455d830ed10ed25055b6b16c06d))
* v1.1.0 — form fixes, user management, document hub, CDE linking ([93063a4](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/93063a4f58637c00e5e6dec5e801008a07ce5daf))
* v1.2.0 — IDEAS implementation + QA fixes + dashboard cards ([0698c89](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/0698c892c00f6f5c498d2716b08e8d0b2aa1e508))
* v1.4.3 — Requirements ↔ BIM cross-module integration ([1544fac](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/1544fac3c1e80608f21cc305ac67e920b0c6a6a3))
* v1.5.0 — BIM viewer UX overhaul + collapsible model panel ([2c59ef8](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/2c59ef8288d87bbf6b046d582d2f4c9f79162022))
* v1.6.1 — BIM-BOQ linked panel, DWG takeoff enhancements, unified layout ([c1d0e60](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/c1d0e6089a7f5dbc17238db4d8c08811a47d7923))
* v1.7.0 — 28 tasks: bugfixes, UI polish, feature enhancements ([38d5ae5](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/38d5ae5eb994a9e2175de4ee4ab4ea05abe08ead))
* v1.7.0 — complete 35-task sprint + animations, takeoff linking, BIM rules ([88230c6](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/88230c61d3f2e9af772bd9640dcd8b2c8fe29fc1))
* v1.7.2 — BIM↔BOQ linking fix, reactive summary, aggregation semantics ([a95f5f1](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/a95f5f1008c4ae22379c729b8686393ea1035e08))
* v1.8.0 — BOQ↔Takeoff linking, UI polish, decorative backgrounds ([dd4a855](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/dd4a855f4eaafb93bd6c68e587cc4d0a63cc1140))
* v1.8.1 — DWG↔BOQ picker + Takeoff decorative bg + DWG summary ([966a109](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/966a1092171c7c9de261b37491cb4e7e7e3f956d))
* v1.8.2 — Documents routing + BOQ link fix + DWG filmstrip ([9d474d8](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/9d474d84bbf2eedc64683367f5170ea91b999420))
* v1.8.3 — BOQ Apply-to-BOQ CTA polish + BIM filmstrip fix + Dashboard quick upload ([17a70ca](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/17a70caa5d10b7d2ba28afe8184f16e847dbe2ff))
* v1.9.0 — R1 critical bug fixes (8 items: [#2](https://github.com/datadrivenconstruction/OpenConstructionERP/issues/2), [#5](https://github.com/datadrivenconstruction/OpenConstructionERP/issues/5), [#6](https://github.com/datadrivenconstruction/OpenConstructionERP/issues/6), [#8](https://github.com/datadrivenconstruction/OpenConstructionERP/issues/8), [#18](https://github.com/datadrivenconstruction/OpenConstructionERP/issues/18), [#23](https://github.com/datadrivenconstruction/OpenConstructionERP/issues/23), [#27](https://github.com/datadrivenconstruction/OpenConstructionERP/issues/27), [#33](https://github.com/datadrivenconstruction/OpenConstructionERP/issues/33)) ([75fb40a](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/75fb40a28aaf577fa11e6d1b3a87c04db53f38e3))
* v1.9.1 — R2 deep-research (7 RFCs) + R3 UX polish (9 items) ([32e4a56](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/32e4a56a2b03ebec36046384e7fc82cb2416e7bc))
* v1.9.2 — R3 [#20](https://github.com/datadrivenconstruction/OpenConstructionERP/issues/20) + [#21](https://github.com/datadrivenconstruction/OpenConstructionERP/issues/21) BIM toolbar polish ([00c97df](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/00c97df201dda062a042cba8cbaf9b7fb6ed2d4d))
...
* v1.9.6 + v1.9.7 — reliability hotfixes + workflow polish ([4d98733](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/4d98733c7c0a164d17555a3740844cb90c6bd32b))
* v2.0.0 — second stable release ([f2e284e](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/f2e284e64885af78b143933320b8964053c04ef6))
* v2.1.0 — Q1 UX deep improvements + RBAC bootstrap fix ([4655543](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/4655543c187630e82306a3517ad16113a7afbce6))
* v2.2.0 — Pivot viz modes + wider Charts + DWG render fix + Q2 UX polish ([40c185c](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/40c185ce8e80b9f4c4b4faf6d9956e8878b96b06))
* v2.3.0 — ISO 19650 Phase A: Asset Register, COBie export, Scheduled Reports ([76ab35b](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/76ab35b860fac3eeef5150a011bc8e3cc64f96d0))
* v2.3.1 — Hardening pass (email service, tenancy, logging, first-run UX) ([412d69a](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/412d69ae2be07560dba0dd5dec08765536286b82))
* **validation:** implement validation module backend (critical gap) ([669b071](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/669b0719fec9440c7cd4ff241ab2859ef81c3a2e))
* **validation:** v2.4.0 slice D — i18n messages + GAEB rule expansion ([4e31cc0](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/4e31cc0470ae1194aca22f1e619688cb3d838df7))
* **version:** single source-of-truth from package.json + Changelog v0.5/v0.6/v0.7 ([990b14b](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/990b14be70e1bc210a62b9d670dbcd665b5629fe))
* visual create forms for Meetings, Safety, Correspondence, Finance, Procurement ([ce3bb96](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/ce3bb96cd77c350a1be447eafae80eec71288cca))
* workflow engine, CDE states, all 15 events, bundle optimization ([bb86af7](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/bb86af7403515b543b7d17de88a2355b02ad541f))


### Bug Fixes

* 15 critical bugs from QA deep report ([142b8e6](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/142b8e6555958a3e3214e28a8cbf8133338dec57))
* 3 critical bugs in 4D Schedule + 5D Cost Model (27/27 endpoints pass) ([7c76318](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/7c76318333229f510baac984fee1b58420469a4f))
* 3D geometry loading — HEAD 405 broke GLB detection ([7d276ad](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/7d276ad9c2e81ab8a3099168f994ed60ff2d2afa))
* 42 (round 2): login slash + demo seed PG type error + cli polish (v1.3.14) ([13800af](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/13800af647c3141d8b5a6d4f7e9935e19a4bf0d5))
* 500 error on position drag — eager attribute access prevents lazy-load crash ([db93d77](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/db93d7743e3b4a3af2bb6f2482d24ffe66765136))
* 6 browser test bugs — language switch, Finance crash, route aliases ([ad0c805](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/ad0c805c7a22dfa6c28e2c8fc18ab5de4f1bc771))
* 9 critical/high bugs from installation test report ([cdce294](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/cdce294bd3ce1ee34ebdb4e3995f3b1758bbc5df))
* **about:** Book → Guidebook, BIM workflows → Data workflows ([aaedffe](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/aaedffe3cd5a8cce08c7cd0ff8b864390496905f))
* add 'navigate away' hint to geometry loading overlay ([fdd00b7](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/fdd00b75813d6959c70c81def5ef90cea11af552))
* add fetch timeouts — 5 min POST, 1 min GET (prevents CWICR timeout) ([93b4f9f](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/93b4f9fd45e5af841191f01ecea8203cef12026d))
* add missing BaseModel + Literal imports for RenumberRequest ([248e3c7](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/248e3c7b2f9f6d1a6c820e57bde31fde7117757c))
* add missing BIMProcessingProgress.tsx + tighter inner padding for /bim and /chat (v1.3.12 patch) ([cb2ee87](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/cb2ee87261015e92c695cbf8c4b9620b8c0b799d))
* add project selection guard to all 11 project-scoped pages ([14e4cbc](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/14e4cbcc93b367915d65ae557532373b00c69e79))
* add react-is as explicit dep for recharts 3.8.1 peer resolution ([9b3cd6a](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/9b3cd6affd74207031cb760dfcb9ca97cbdd1d53))
* add server_default for is_permanent column (SQLite migration compatibility) ([10ae1ca](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/10ae1ca25a0a0778565572c46c6997cd57a0baf6))
* add trailing slash to ALL 369 backend routes — eliminates CORS 307 redirects ([90fbd6b](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/90fbd6b4d01d2e2890ba5b0e49a922f05900d9bd))
* add trailing slash to ALL POST API calls in new modules ([871aa00](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/871aa00cef6f80d7ced11a1e5b4269c6f03d3b15))
* architecture edges use smoothstep type with ArrowClosed markers ([41dd472](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/41dd4723e1da51855d9471adcd8b583f4740442c))
* architecture edges visible, BOQ create-revision URL, costs→BOQ ordinal fix ([c25e6d9](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/c25e6d99eeac02746920a72b9adf59e04a65b365))
* architecture edges with arrows, light grid, 20-lang translations ([d3ead36](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/d3ead364d7642e9bb1726b9ed5f9e36bbf4dcde1))
* architecture light theme, vector index 500, notifications, cascade delete ([8c890d6](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/8c890d6ed79d0a9f6f94a186ab6dd20eacc7c11f))
* audit fixes — AbortController wiring, header injection, dead code ([402f09c](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/402f09cfbef623abf2430011f827ecca9ba439a5))
* auto-detect Z_UP by bounding box — rotate only when needed ([3803cad](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/3803cad1c12bc701f6c8a61568c7274e3344bcf5))
* **backend:** critical bugs from QA test report — ChangeOrders, projects, 5D budget, Requirements module ([111627a](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/111627a22f61a65662ea436362cbadb3dbf14a5c))
* BIM + DataExplorer landing layout improvements ([4483ab3](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/4483ab38e6be5e093cb0783a124f8fe818363b47))
* BIM bottom filmstrip layout, stale model cleanup, deep audit 10/10 PASS ([de826ff](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/de826ffaea8269634ca16a957e87fc449fc838e1))
* BIM filter Category/Type/Family alias collision + collab lock leak ([38c3ee3](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/38c3ee3337fb38ac16e45aea1c4913d9ae5ffc01))
* BIM page warns before RVT upload (needs converter) ([923ee83](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/923ee83420893c54c85472a3f5f782c04e85fed9))
* BIM response field mapping + Settings flat LLM provider grid ([d72ea48](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/d72ea481bba1e002fca9e2a1dd02e501e71a585d))
* BIM RVT processing actually works + 17 unit tests (v1.3.4) ([1bd8a37](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/1bd8a376e00836afabf0ec9f1aa01bc6cc96ca74))
* BIM selection — recursive raycast with parent elementId lookup ([4606dfb](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/4606dfb831f88a60008a9029b436fdb64c9e539b))
* BIM shows models after upload, CDE info box, remove Quantities nav ([d465c58](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/d465c58d653af99edd2ccadbec26a922f32681de))
* BIM single upload zone + Integrations layout consistency ([f0e00b3](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/f0e00b33002adedefc28f934830302b4c8c2925e))
* BIM viewer auth + /chat 404 + cost DB endpoint + big AI Chat FAB (v1.3.6) ([9926c96](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/9926c96cff5e9844a8b4c0bc46102a2fe2926cbe))
* BIM viewer camera fit for COLLADA scenes (v1.3.19) ([fc8f5d1](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/fc8f5d16aa53d04edcd774b5deaa27323613cb69))
* BIM viewer colors + camera + global padding + Day 4 audit (v1.3.18) ([3d1ea56](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/3d1ea562b17be3fd813e688df935b2fc0bd8592e))
* **bim:** improve empty state — show guidance when no models exist ([38fe351](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/38fe351d3552600ded48145f1d85095e9b2180e6))
* **bim:** project guard on upload + network error message ([6fb826a](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/6fb826a1a272c1293c65b0303fa3bcadf28a4eef))
* **bim:** RVT/IFC only + upload progress bar via queue store ([820454b](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/820454b14fbaaa298df8f7dc69922b1fdbbb461d))
* BOQ api trailing slashes + cost_database source enum ([83775c3](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/83775c3a5ec9cd18519ee560187db3c49e0b1300))
* BOQ description disappears while typing (Chris Keenan bug) ([8d40a99](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/8d40a992b94683d41fa216b50a34a1c174475282))
* BOQ description editing — replace broken autocomplete with standard editor ([78f051c](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/78f051c59cdb1aa3b55619357817f8a9707ee343))
* BOQ drag-drop updates parent_id when moving between sections + toolbar spacing ([780b29a](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/780b29a4f69d9dac3705fcc5ead8735c77920d4b))
* BOQ editor — hide tips when positions exist, compact header spacing ([f6b84b4](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/f6b84b4a5e8aead0d29a454f4f3e482a5e8e4a36))
* BOQGrid crash — destructure customColumns prop instead of accessing undefined props ([623c2dc](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/623c2dcf9495da8f8a2e6640e6773a52a50ccdcc))
* Buckets taxonomy — sketch/path/mass lines classified correctly ([4edb1b1](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/4edb1b1aa71e47bd767843aacc26c2d28b869e49))
* bump backend app_version to 0.8.0 in config.py ([55f66fc](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/55f66fc86263089d7c38b78af0ad8675c172cfc9))
* CAD converters section — clickable install links, GitHub source, better UX ([e0aaa24](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/e0aaa24ac3639da8a1523f6d97a23e40a5958450))
* CAD Explorer — add missing format field, bigger buttons, Data Explorer link ([483119b](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/483119be23e3108306008fb21bcc0a773d240561))
* CAD takeoff converter status banner + proxy to port 8004 (temp fix for ghost PID) ([e6a9def](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/e6a9defb4734a5236a530e0e4a728327724b37f3))
* CAD-BIM Explorer — show upload zone on session error instead of dead end ([1782809](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/17828097df9acc8f44276601a2ca95ca6a87193a))
* CDE field mapping + BIM CAD upload + 10 new LLM providers ([a63f103](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/a63f103c91d9513aa87b41af940d63076288f66b))
* CDE project guard + contacts template download + meetings AI import ([d5d97d4](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/d5d97d4fa380cfbfc41db1d9adb06af189282009))
* clean stuck BIM models + schedule/costmodel tweaks ([997401c](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/997401ca0c7527e0c8701d8f55481b0249275331))
* close upload panel on submit so centered progress overlay is visible ([677564e](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/677564e9eef268dedff7c9cb37240f77a401edee))
* compact inline buttons, kanban priority stripes, RU translation "Точка"→"Этап" ([f41437d](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/f41437dd7525d623229a897b3acfc1deab299947))
* complete Pivot tab rewrite — auto-run, multi-column aggregation, sorting ([cfd345e](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/cfd345e82a7ecc8f4903e181f9f85b6beec0fc27))
* consolidate all imports into single block — eliminates duplicate React/lucide imports ([542a5ad](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/542a5ad526e62c7101adc9a0be44525dd3e64d91))
* correct GitHub link to cad2data repo + install links go to /modules page ([bfe6b29](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/bfe6b29130700228601ceade254deb1e3d78a171))
* correspondence crash (to_contact_ids), integrations moved to settings, sidebar cleanup ([161628d](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/161628d3064528326613507ce2bd3d257519ad46))
* Correspondence integration links, Finance deep UX, BIM processing state ([7b0d3c9](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/7b0d3c9d47e8ed246b76f381dfad043ed7831d27))
* Create Revision button — MissingGreenlet in duplicate_boq ([b482bfb](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/b482bfbe10e4c70db6bbb48affe8180b5f748792))
* create thumbnail subdirectory before writing SVG ([2415902](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/241590287c794e03d73ba13735a2ef6f8fef5750))
* critical bulk-insert batching + 4 medium audit fixes ([72bdc26](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/72bdc266f67ed7af19965900536121094b8f33dd))
* critical business logic — project validation, total calculation, bulk import safety ([93a0331](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/93a03313772b47b33618cb0ba628c6bbe51a815a))
* critical security — backup tenant isolation + rate limits ([8d7b298](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/8d7b298c2467e6f38eec7b6e2ee5436565e0b650))
* critical type mismatches + API guards across all new modules ([f50d0ab](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/f50d0abe13502c98252de3faecbb04426885d717))
* **csp:** allow regional Google Analytics endpoints in connect-src ([c8a5aa0](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/c8a5aa029e0c08183b1bdeb5874bd1e73f0e5917))
* Ctrl+Click and Shift+Click multi-select now works reliably ([12333c0](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/12333c0bad79f936edac96ca0f6ab6d5af733e8f))
* Ctrl+click multi-select highlights persist + AddToBOQ hides sections ([d03f460](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/d03f46037eaed8379c5b7c53a58e782c693f6768))
* dashboard 404 + geometry fallback + BIM UI polish ([304058b](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/304058b71811146ce3a3a6bed37b52294c6e6233))
* Data Explorer — all text columns available for grouping, numeric only for aggregation ([3f9b3c5](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/3f9b3c5a4be976f3f93871f50405fc9614602f5b))
* Data Explorer — floating queue panel, aggregate fixes, column filtering ([ca6a23a](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/ca6a23acf413faefdeaebef2ce33d54bdf10bc1c))
* Data Explorer — use standard max-w-content width, professional UI polish ([17a7543](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/17a75430b917c51e8b613c1297119017f9c0bd71))
* Data Explorer landing — compact professional layout ([d966fd2](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/d966fd2e1db60c0f79bb1aa552283116f834a32d))
* DDC IfcExporter integration — storey, quantities, skip non-elements ([35f6b41](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/35f6b413a5370f0f0d5400d9bb7190b4ea112949))
* DDC pipeline — remove 30-property cap, standard mode, accept all CAD formats ([81edc29](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/81edc29db531b2626837d69d60187a3185abaaaa))
* deep audit — 14 bugs fixed across BOQ, Projects, Users, Costs, AI, Schedule ([7e96e7b](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/7e96e7b74938b0147a798160760af79559c27588))
* deep audit batch 2 — 26 bugs across 12 modules ([689124c](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/689124c9c4d63e913ff7db24cf351dabd30d3833))
* deep audit batch 3 — 10 bugs across 12 remaining modules ([318a3c6](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/318a3c696a2d0178c42afb6160319261e0436cc1))
* deep audit final — 23 bugs across 10 modules + cross-module consistency ([ba9e0a8](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/ba9e0a839aae81ad9895b827cde64174e8c90b83))
* deep quality audit — security, concurrency, memory leaks, i18n, UX + tests ([1665217](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/1665217f2ad03fa5dcd52f9e502b7289d2174d01))
* deep UX/quality refactor — PDF takeoff, CAD/BIM, markups, all modules ([b43a2b1](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/b43a2b16729e3ea21415b0e1de6900e20833d438))
* default conversion depth → complete (all Revit properties) ([986470f](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/986470fb31c0c7721cbcff467bb224114147407b))
* demo login auto-registers if user doesn't exist, clears form errors ([6a69663](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/6a69663a0188d84b82bae181e0729170f5134a2e))
* disable OrbitControls during Ctrl/Shift for multi-select ([06f3d13](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/06f3d1392a4410e52f99d28d973f2725e78381ec))
* disable redirect_slashes, fix BOQ parametric URLs, ordinal conflict ([d104b5d](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/d104b5de7791fdafa9566b75dcbb39a656d65769))
* Documents page shows ALL CAD sessions (including unlinked to project) ([56420de](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/56420de44527a6c1da5dbefd371b7aa40b8f7751))
* DWG menu — PencilRuler icon, add English i18n fallback ([8d83924](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/8d839245cdf9f51896345d5348e51e3ff9f8025a))
* DWG module — Compass icon, upload params, i18n for 20 languages ([82c48e3](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/82c48e3a9275d621583c5bca4dbabcaaad319a86))
* DWG parser — correct extents from entities, ByLayer color resolution ([4e8b414](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/4e8b414912d75666495c72aade938d622ff6433e))
* DWG Takeoff API URLs — use underscore to match backend mount point ([e94cffb](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/e94cffb97a0064d32ab65ceb84417b145af983a3))
* DWG Takeoff production hardening — 24 issues resolved ([ace5b92](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/ace5b920c9bd00e71c188e7c3ddc35009e5c193a))
* **dwg,bim:** cross-state leaks on drawing/layout/model switch ([1ce295b](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/1ce295b32684daf3936addd6c49105c240d0971b))
* EVM SPI clamp + CPM topo sort + risk 5x5 matrix + N+1 (v1.3.17) ([690f203](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/690f20366ed181d24dfb404c2e8ce8a4c3b70496))
* Field Reports CRITICAL — broken store selector caused empty page ([79085f5](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/79085f590dc74ef04dcb3ce4d44f5fc027f764d3))
* Finance/Safety create forms, Tasks import, BIM UX, Contacts download, Correspondence connectors ([1107fca](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/1107fca1bcb190a943a9ca0d724bf0a0a56187ba))
* frosted glass effect on BIM filter panel (left sidebar) ([43a40de](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/43a40de577c5abe20ed6fae8671502d93a2bccd1))
* global PROJECT_ID declaration in main() for proper test context ([ceee80f](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/ceee80f810e183c2c8c7cd3f797762b4fb799f9f))
* grid hidden by default + Grid3X3 icon for toggle button ([d619358](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/d6193585f0c8b4dfdc3ddc95e230d5c5d2a36462))
* header dropdowns hidden behind page content (z-index 20 → 100) ([33f938a](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/33f938a8aff6b60a71826f7cd586e817d7807e9c))
* i18n compliance + accessibility for BIM module ([62198c6](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/62198c67d188e3cc70b33f1ac9413bc61dbd9189))
* **i18n:** remove Ukrainian language — keep 20 languages ([21ff91d](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/21ff91d44d2e663548219a3e9043818e0a2a25c2))
* Integration category-colored icons + Settings column balance ([864885e](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/864885ed9c9d853776abdad1d998637a5387f0c5))
* integration test login retry with backoff for rate limiter. ([c0973b1](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/c0973b10279dd38c88a1dd7d98564065344fd9f1))
* LandingPage upload now triggers centered progress overlay ([346dc66](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/346dc66042010b43b7a0dd7ada4eb918eefca854))
* left filter panel now absolute over canvas for frosted glass effect ([928e476](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/928e476d3b4989d09a4396691822f6984d5d25cd))
* left panel opacity 92% → 95% ([4e62a23](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/4e62a23e1c46670f34eb833aaecbfbca1af9ad87))
* left panel opacity 95% → 98% (nearly opaque) ([6bdc187](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/6bdc187b8842e7fe7d64a346551ab2a4d3a2e1da))
* **license:** replace OpenEstimate references and align copyright ([2248a33](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/2248a33e4bc575dc4e1694691a89b61882c4c84d))
* live total computation for positions without resources ([c9eb01a](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/c9eb01af5295eff724c14000c1829bdca02c4f06))
* logo links to site with UTM, removed bottom branding link ([e8791f6](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/e8791f65040e78f9f7932ee2c0a8e96e47cfc77b))
* make every BIM mesh selectable — full element coverage ([4819e55](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/4819e55d7db2bc1db8bbe04cf25d81827c18dce5))
* markups API types match backend exactly (10 markup types, correct field names, endpoints) ([d0cc27b](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/d0cc27b583d066b88c91c3e2218fb1afe2c5cfa0))
* markups author_id optional (set from auth token), author fallback to user_id ([5bfcc73](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/5bfcc737df8c4966710b1f4f1fa2bd729af4a61b))
* markups document dropdown always visible — shows hint when no docs uploaded ([34095a0](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/34095a045a5f77f09093194dec8c7279565c1ce7))
* markups page — project selector, document filter, stamps UI, type icons ([e80159e](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/e80159ece93084b0c8c55c7c58d96ea1c2005768))
* Models panel — remove bottom padding, add centered drag handle ([e30520c](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/e30520c852984b13e4aa5ff10e1bb5e2d74b399c))
* Models panel wider with always-visible title + left panel glass ([2983083](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/29830830eccffa16b1df793c49cf6cee58691b8b))
* Monte Carlo percentile array index clamping — prevents out-of-bounds crash ([85ffa64](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/85ffa64acacc47e7defa7a44ad7746a8b0035202))
* move ALL imports to top of file — eliminates 'Cannot access data before initialization' error ([8b50938](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/8b5093818586ff2d5c14d9bb97a7f1518ffd36b7))
* move boqApi import to top of file — fixes 'Cannot access data before initialization' error ([3853c2d](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/3853c2db5c8566ee33dcc4aba69d3b008d620fae))
* move colStats/heatmapBg after useQuery — fixes 'Cannot access data before initialization' ([7e7d5ad](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/7e7d5ad869116e8b80577937388988971b2db3b7))
* move Reports to Documents group in sidebar ([9664cea](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/9664cea2ce93403b1c8ea49d7ae665f8b7e2e45a))
* move useMutation outside conditional block — fixes React hooks order error ([3f48dd8](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/3f48dd84856cfcc3b3c848cf96a0ade73c25a3b1))
* onboarding background DB loading + CadExplorer unused import ([d0bdb6a](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/d0bdb6aa161c9375cc373c62308adf22d80b0993))
* **onboarding:** modern toggle, all 11 regions, profile→modules flow ([694da58](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/694da581a10b229f8daa71fce3d9603319b87c18))
* Parquet schema normalisation — include ALL keys from ALL rows ([2fc0487](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/2fc0487421960f5bdf2084cd6ffc8c63e56ed889))
* Parquet write crash on DDC non-breaking spaces + mixed types ([06867e2](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/06867e25ef7dfeb8ccd69ed13cb7e0f014e6aa7e))
* PCI page — better error state for 401, header description, auth hint ([65d527b](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/65d527be49ef8e941db8418e546ba222603d2445))
* PCI page auth token key (oe_token → oe_access_token) ([003b14f](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/003b14f7f17033654c9bc27d2abec74608a832df))
* PCI page proper empty state + apiGet auth + sidebar UTM link ([af6d749](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/af6d749d685ebc692e7299e54689327b5c84e1fc))
* PCI page uses apiGet/apiPost for proper auth + form validation audit fixes ([dc72d86](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/dc72d869ccbfee34bee82acd9b0dc297c9958dd4))
* PDF takeoff page-nav reset to 0/31 + alembic multi-head + win32 marker ([a68a3f7](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/a68a3f79e06352c7eb3d4a20a1d34276be546f18))
* PDF-measurements i18n for all languages + CDE create guard ([aca1d0d](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/aca1d0d2de1d69e43094e2fd1cdb798a89c6bb65))
* PhotoGallery — TS errors (outline→secondary, icon as JSX, unused import) ([af1c9cc](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/af1c9cc89368277f09e7930b18031d54c06dcbb7))
* Photos error fallback, Transmittals/Submittals info banners ([e2fb25b](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/e2fb25ba75913ff5019f10492549ab23b8fb0ca3))
* Pivot/Charts — smart column selection, quantity keywords prioritized ([dd31f72](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/dd31f7207550d4a6c565735cc8b2845eeae4bdc6))
* position PATCH 500 — flush session before reading attributes, robust activity logging ([a665725](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/a665725a307ecf41c235881a0cf88e6fe21d5646))
* prevent 422 errors — guard all API calls with empty projectId check ([f822321](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/f822321183571c495fb5218d9bb248fc3ba8f066))
* project switcher empty — limit=200 exceeded backend max (100) ([453ed6a](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/453ed6a91d00c7003cc0446868092b30196de898))
* punchlist — all API paths fixed, project selector, overdue highlighting, validation ([6fc425c](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/6fc425c87d837011a09710d517ca2a868a60e9cd))
* punchlist buttons inline — whitespace-nowrap, compact action buttons in table ([f62791c](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/f62791cb18e470b4a54604d680c3d3aea30829df))
* raise BatchedMesh threshold 1K → 10K — selection highlight works ([f7bccff](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/f7bccff2d0986b0932433d33f79480d092687244))
* raycast against full scene — select walls, columns, all elements ([37dcecc](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/37dcecc5724d63386e639dd75bc3fbb4d95772d6))
* React Query staleTime 5min→30s + 2 missing cache invalidations ([7423152](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/74231520ada3f2bbdf44a5f17e11217cff01c5f4))
* README badge version 0.9.1 → 1.0.0 ([7446b6c](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/7446b6c694f4c576ca3a36b6e3a87a7b421bd3e7))
* real Revit COLLADA geometry + 16k element limit + chat tables + i18n (v1.3.7) ([b15ae5e](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/b15ae5e6434e7176896d30658527b340c82a3fa4))
* reduce left panel transparency (80% → 92% opacity) ([eedb9d8](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/eedb9d8b3dd2fa58a6ea99e8c5258110f2c9e77e))
* remove activity logging from position PATCH — prevents session corruption on drag-drop ([61aa9a3](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/61aa9a35ee4935b09ce59c0b8663cff9ff3b30f1))
* remove AI Chat highlight from sidebar — no special treatment ([470f5a7](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/470f5a7e801ea639cdfe86dbe52e622fbac86cb8))
* remove boqApi import causing circular dependency — use apiPost directly ([a9f04fc](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/a9f04fca8b1fb71c81705d370fcbdba2a42e6322))
* remove double Z_UP rotation on elementGroup — model no longer flips ([3bea937](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/3bea93780012dbc15569fc8d5daccd5b3bceb128))
* remove GLB rotation — trimesh already converts Z_UP to Y_UP ([e2259e7](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/e2259e746e32b4519422ea8729226cdaddc129fd))
* remove Google Analytics from repo — injected by VPS deploy only ([9d0fe7b](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/9d0fe7b52430d9c2ce853f31a54b2e60e85cdd34))
* remove leftover code causing IndentationError in update_position ([bef8a80](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/bef8a801ccae42a1aff988ae7f5c02d1ae24d432))
* remove unused useNavigate() in CadDataExplorerPage (build error) ([7b5067a](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/7b5067a7adc512113e1721e62f6ad7aa370e4f3d))
* remove unused variable in CostModelPage histogram map ([af370cc](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/af370ccaf520ee60475590655550d2fd5f87bef0))
* rename Data Explorer → CAD-BIM Explorer + add i18n keys for new sidebar groups ([20c8731](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/20c8731cbb9455db9da31d359d471d173a6ec3ce))
* rename PDF menu items — 'PDF Measurements' + 'PDF Documents & AI' (21 languages) ([4f70003](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/4f7000346a0cfc581506608827ef45544d62dddd))
* requirements export response_model=None (FastAPI startup crash), restore proxy to 8000 ([d8a1bd9](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/d8a1bd9cbd6eca839f8993c04b05a936b39dc57e))
* requirements gate MissingGreenlet — commit + re-fetch after create ([d442b4d](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/d442b4d0535d53245f011d967892f78a70c00bcd))
* requirements gate returns 200 (not 201), scale calibration_points accepts Any type ([af7213e](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/af7213e8d022af11f55af98d5ead5e7608318167))
* requirements header — no-wrap, shorter title on mobile, overflow scroll ([ca8c736](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/ca8c7364241e8474f5b617403e3db22eb359926e))
* requirements header layout — title/button on one line, selectors below ([5b8b315](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/5b8b315bdea093e541b4e8f5ba006307cbf331b5))
* requirements module — all API paths, types, gate statuses, and translations ([26b76b8](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/26b76b83519fd67c3a779ee37e47c69b69f55b8d))
* requirements page — score display (was *100 on already-100 value), add project selector ([fd5c46e](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/fd5c46e33c09899e34cdedfac8f5f13f2e3d2842))
* **requirements:** gate pywin32 on sys_platform == 'win32' ([451f6f2](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/451f6f2f8eb413768425e015021a9feb336f2ced))
* resolve 5 TypeScript strict errors in RequirementsPage (CSV parser, unused vars) ([008e6e1](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/008e6e14de7f549db2192edc3ed9410499ba7cdb))
* resolve all remaining TypeScript errors — zero errors on tsc --noEmit ([a3ddd5e](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/a3ddd5e9a17a9c292e3b5273221e477c002245bf))
* resolve TS errors — BOQ metadata access, unused function suppression ([68180c9](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/68180c9ecf629ba8e5bab1cd647fa9b4a000f1fc))
* resolve TypeScript build errors (fixes [#42](https://github.com/datadrivenconstruction/OpenConstructionERP/issues/42)) ([e6d4802](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/e6d4802dee5f3e0456be54015086735e31240ed7))
* resolve TypeScript errors — type casts, null checks, unused imports ([1a31f25](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/1a31f25cec998257b52c12f8da364dd23fbcb495))
* resource row alignment reads actual column widths from AG Grid API ([6b75e28](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/6b75e280a91c70e424f533abc117e6cee765b8f1))
* resource total calculation uses pre-computed r.total for accuracy ([39d1bca](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/39d1bcaeb0a0134df00e70e43b13b7e72fc68a31))
* restore redirect_slashes=True — was causing 404 on all new modules ([acbb6c8](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/acbb6c88298aa894cfdd431d6889e71ca6aae197))
* Revit Categories chips — force text-left alignment ([3272f60](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/3272f606f4537205cccf558ea42e117f885af4a1))
* rotate DDC geometry from Z-up to Y-up + backfill smushed categories ([f9e6b92](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/f9e6b92bad060664bed78003bee27f6e9fe2f541))
* rotate placeholder boxes Z-up → Y-up + UI polish from deep agent ([d9e59b6](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/d9e59b67257c05890c7287bc0ae398b34098f1a2))
* Safety POST trailing slash + RFI auto raised_by + Transmittals schema match ([df2abbe](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/df2abbe24c12574c1c48db0cc5713c5d585bb760))
* search includes storey + i18n summary bar (deep QA fixes) ([fcc3a9f](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/fcc3a9f6a6f6871fd1b63f80462ee1cbc7cf94e9))
* security hardening + silent-error fixes across modules (v1.3.1) ([8a273c5](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/8a273c5a0289a383ae2467f8878206155053a656))
* Settings page — two-column layout on wide screens, full width usage ([1013852](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/1013852baf7bb0d415ac879a2a2312c5e97ac2e4))
* **settings:** move Yandex GPT before Baidu, remove country reference ([a4c1753](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/a4c1753988caf1c7f538425afd86c518b9315e37))
* show ALL CAD sessions in Documents (not just saved) ([3a8a2fb](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/3a8a2fb49b640c23f22bd41a4b84478bd7c02625))
* sidebar reorganization — Requirements+Risk in Planning, Field Reports in Documents, removed Field group ([9863129](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/98631298daab92cd5ad8c84d0d0660f512123344))
* simplify UTM to ?utm_source=app ([c88c7f5](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/c88c7f5a96b8cd58da07afedcf31a741350aea70))
* skip Google Analytics on localhost to prevent login interference ([eb0c977](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/eb0c9770b9153ed41996bcabc342e788b27c7dc8))
* skip Topography/Site + toggle placeholder boxes (B key) ([ab1f6d3](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/ab1f6d36e7b87b6747dfa0d97de4ca8b6515345c))
* smooth orbit controls — prevent camera flip, slower rotation ([d9226f2](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/d9226f218d6cbd17425461514e9edefce61a3667))
* split CamelCase OST_ categories into readable names ([e0ed3fe](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/e0ed3fe1987cf7305626e4ad8d6944dde9622789))
* storey filter + Ctrl/Shift multi-select now work correctly ([af15f08](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/af15f084899646976dc25e7170a26753f52ccf2e))
* storey filter hides all non-matching meshes + frosted left panel ([23e6c9b](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/23e6c9bd92d64c433f5a64763c655e1b656cffa3))
* Storeys → Levels stat pill + skip DDC 'None' category string ([0a1b1bd](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/0a1b1bdc7edf050038f5863583a6f64f960f0c4e))
* switch qty/rate to agNumberCellEditor — reliable single-click editing ([b9c8e32](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/b9c8e326f0e9cefbd772ffc8498f6699b1e30094))
* **takeoff,setup:** drop-zone honesty + Esc race + Delete key + make seed ([9af79e3](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/9af79e3dff2abc0ea63a571eae0538dfc45c1b4e))
* **takeoff:** cross-page state leaks + expand Vite optimizeDeps ([4957155](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/4957155bb0a1d48b6c14c70ab49c7c7812769fb3))
* Tasks priority medium→normal, Contacts prequalification default, Finance toFixed crash ([b9462b5](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/b9462b53482a6f1362c1fbced8d1b14d917e3c08))
* tendering String(20) truncation — expand deadline/submitted_at to 100 ([769d075](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/769d075bb828d314f150732734811ee83b27d732))
* text import adds to existing set (was creating new), re-fetch after commit ([01eaa46](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/01eaa46a3d12b5e454dae5e77029dc12e5e7cb63))
* toolbar icons — distinct icons for each button + keyboard hints ([9ad5561](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/9ad55613e9edba728976888b2531e020c62a27db))
* **ui:** compact sidebar — tighter spacing, smaller icons ([6bbdd57](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/6bbdd5705da0d54e128bc084a79ac5dd6fa0c293))
* **ui:** further compact sidebar — Notion/Linear density level ([7d79d28](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/7d79d28cbe394229b3d45b9b771b9b479f84bc72))
* **ui:** standardize all new pages + complete 20-language translations ([46af9ad](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/46af9ad828c6540c9f807ab42e1bea16320ce9ba))
* unit dropdown + ezdxf in Docker + audit fixes ([7cae280](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/7cae2806db7b7f2e701090d44ac48db773a6ada0))
* **update:** portal full-screen modal to document.body so it escapes the sidebar ([9e6928b](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/9e6928bb24f647f6b1c12e986f758d40136a4c26))
* UX polish 100/100 — buttons, API guards, empty states across all pages ([c53d937](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/c53d93753ed0fc41042770ef365013c9024049af))
* v0.2.4 — mount_frontend AFTER module routers (fixes all PyPI versions) ([afd1746](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/afd17460f4809bb6e6b062e9b6d556d97f02ad80))
* v1.1.1 — comprehensive QA fixes, trailing slashes, project guards, architecture map ([65cc9e2](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/65cc9e2d21ef89ac8456d39a07e28e82748b679e))
* v1.4.4 — backend hardening cut + version-sync CI guard ([2cf8d17](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/2cf8d174c46c23b162722f61f12dce34ac31ed51))
* v1.4.5 — deep-audit cut + cross-module integrity + i18n + tests ([a9cdfd2](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/a9cdfd2bc9f04decd7965e1da943dbb3442aa9a3))
* v1.4.6 — security IDOR fixes + cross-module wiring ([c6352f3](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/c6352f350d67be9aedadf02420b7af1614793202))
* v1.7.0 polish — layouts, markdown, drag-drop, contacts CRUD ([895f3a2](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/895f3a28d72faa901de1282b27dfafe2d7720951))
* Windows silent startup exit + /demo/ 404 + lazy vector checks (v1.3.10) ([d97f334](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/d97f334384abaf7bbce40f1796372700b268b939))


### Performance

* add staleTime to project list queries across 20 pages ([634410f](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/634410f89d39f2a8f88f281f875c4be255982b82))
* add staleTime to project queries + fix HTTP status constants ([4447f02](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/4447f02aab20393c0c9c5dbf8a8af4ddbb6aa077))
* GLB geometry pipeline — 8.8x faster BIM viewer loading ([91d5b8e](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/91d5b8eddca26dadc9815a41ec229460de8d0b09))
* staleTime on remaining project queries (4 pages) ([adb4a72](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/adb4a72f07008e75846318686bc77c4d995c9b55))


### Code Refactoring

* code quality sweep — keys, a11y, types, sorting, docstrings ([07e16f1](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/07e16f104b39aa31fdc1a82d83a6f363c52036c6))
* complete markups page redesign — compact, professional, functional ([855cbbd](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/855cbbd28bd8091998919d19394f4353f3ec2b35))
* deep quality audit — 80+ fixes across all modules ([1c099e3](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/1c099e3bc11f774f364da4c676499d52b2bd51ca))
* improve error messages, config defaults, validation helpers, API timeouts ([bad638c](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/bad638c18a77f7a02187547646c57a52ff1cb4c5))
* **nav:** reorganize sidebar into logical groups ([2c4cc84](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/2c4cc84724200395e29cd30b01988b5b9925361f))


### Documentation

* add animated GIFs to README — full workflow demos ([b8b25dd](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/b8b25dd82bf60fa6d5d44717cd38896b604ae9bd))
* add pip install from PyPI option to README ([7eef983](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/7eef9838e2951381f9fcd41d2d77c72cbd6df05a))
* add Project Intelligence + User Management sections, update meta to v1.2.0 ([ba42953](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/ba42953151cf38ec83fd8a18ac071ab367f720f6))
* add Requirements, Markups, Punch List to README (20 modules) ([eabb098](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/eabb098637324fd51b26b529060a6c5724a64026))
* add table of contents to README, bump version badge to v0.4.0 ([c273008](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/c2730083d8925bc919ed28583c1cf8c740b65c0f))
* embed YouTube iframe in docs.html so player views are counted ([7a1e336](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/7a1e336f68d9c0a26f5030e9ae4d7e9ac25a8fb8))
* **readme:** add 12-min walkthrough video + reorder See It In Action to video flow ([3d67cf1](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/3d67cf1d74ef0db951b438c74dceba7dfd96e62d))
* **readme:** add YouTube walkthrough link in 4 places (top nav, See It In Action, Quick Start, footer) ([a5a8a8b](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/a5a8a8b32f258dd562c92e37c9c06f4d32f1fe9d))
* **readme:** align social badges to left edge ([97730a2](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/97730a2a7a1172e48b9b5eba946393f43e7d97df))
* **readme:** badge row 1 has 5, row 2 has 3; pepy shows per-month ([b1a6940](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/b1a6940bcac049dfd8ac8a53c5e25dca1fb95448))
* **readme:** badges 6+4 split, ToC 100%, star block to top, trim OFAC list ([c213b9b](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/c213b9bc0f35ecfd045e2aa8c475996d03ab52f6))
* **readme:** bump version badge + footer to 1.9.7 ([e7cb6d0](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/e7cb6d082524246aa494ef4f5bd17571ab403bd8))
* **readme:** bump version badge 2.3.1 → 2.4.0 to match prod and PyPI ([6cc5ac4](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/6cc5ac4d4f5939c25982b6e3ed9a7deab5ecb4bf))
* **readme:** click-to-play hero thumbnail (video tag with relative src was stripped by GitHub sanitizer) ([a2c3ece](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/a2c3ecec780a4c47f2979cb3614742f1e5349fba))
* **readme:** drop '(with music)', point full walkthrough link to YouTube ([569d5d2](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/569d5d22ebbd053e47a549bf9383f006315ccd69))
* **readme:** final — click-to-play, inline &lt;video&gt; impossible without drag-drop ([d792bfd](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/d792bfd23c0b2afa12f737a79b0bd09d670fc8e8))
* **readme:** fix Mermaid Architecture diagram render error on GitHub ([fbd0d32](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/fbd0d32003d1cde0bf31f8faaff77417442b2e01))
* **readme:** inline 1-min teaser via user-attachments URL + link to full 12-min walkthrough ([f1f493a](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/f1f493a825c2cf84b76e2c6b7b59dfafcabbc026))
* **readme:** inline video playback via release asset URL ([745cd46](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/745cd46b89074a269abb75900022a6ae8a62e417))
* **readme:** keep hero screenshot above video (poster removed; sound on by default — no muted attr) ([bac809b](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/bac809bf488b101e31a1e757aedfdbcf0ffec72a))
* **readme:** remove UWG-risky superlative and hard-coded demo passwords ([231a572](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/231a572be4af5bc8f7b895d074c19b9975af0b40))
* **readme:** replace footer with DDC logo + social badges block from cad2data repo ([7d83985](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/7d839856011a143201a303aa5f1734a5421ebada))
* **readme:** revert to click-to-play — GitHub sanitizer strips &lt;video&gt; tags even with release-download URLs ([cc9a073](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/cc9a0737fc36fd56e379eab787d9f83603f25741))
* **readme:** route vulnerability reports to Security Advisories ([ee566ac](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/ee566ac5f4512fa5b84409e29b92fd81bb14b1cc))
* **readme:** simplify Mermaid architecture diagram so it renders on GitHub ([9a3d2eb](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/9a3d2eb86165cae57d31b00c26f9afaf0fa97b29))
* **readme:** tighter badge rows + &lt;colgroup&gt; for ToC column widths ([3b97344](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/3b9734482f82182a4a037e22bd277c778b2d4273))
* redesign Table of Contents — grouped sections with HTML table layout ([561f9c2](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/561f9c26fcb0b7496cbeb141f929b5d98a5c8ffa))
* restore hero screenshot at top, move GIFs to See It In Action section ([ac3d4b2](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/ac3d4b2cb665f0a490be2dce925b138c89d9525f))
* rewrite README for professional GitHub presence ([9781a4b](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/9781a4b116c13c2c0f6d2343945e5e9adcd2fb5a))
* **site:** add 12-min walkthrough video + See It In Action gallery to docs.html ([30194cb](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/30194cbb21ac276a857daf19c250f8f9813f514c))
* ToC table full width + vertical alignment ([19f7f5d](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/19f7f5d31158a5f8d0f70c3261a742e476ea24d0))
* update docs.html to v0.9.0 + add 22 new module sections ([add578c](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/add578cd5b45b3b70bd14ee4156cc12eea158f72))
* update docs.html to v2.0 — drop v0.9 menu badges, refresh highlights ([01983d7](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/01983d7308b180085d9ae9448abf66893671f558))
* update README + Changelog for v1.6.0 ([9e72cfc](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/9e72cfc50f3de2344dc901f4d5b5b218ae9eb23a))
* v1.9.1 RFCs for R2 deep-research items (7 items) ([be35e19](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/be35e190e5dafb279e98cdfdc2e7c219126f2eef))
* v2.0.0 release polish — README overhaul, community files, site bump ([c372439](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/c3724398b9896f8051829e95f26ef385897d89b2))


### Tests

* &lt;video src=github.io&gt; — probing if Pages URL passes README sanitizer ([7f29c91](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/7f29c91e713069d406c02c705d50b87716e2ea90))
* comprehensive 125-test suite for all 20 modules — 100% pass rate ([1ef4f9b](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/1ef4f9bb20eb188848b10ec65533233039b55577))
* final QA suite — 73/73 tests pass (100%) across all modules ([ceee80f](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/ceee80f810e183c2c8c7cd3f797762b4fb799f9f))


### Miscellaneous

* add deep identity markers across all export layers ([dc5b712](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/dc5b71243c740cd8f4c766a68d27a0c75f5014af))
* add release integrity check helper ([a343a12](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/a343a12ef2d9b975f5fcd0176cdb8f005cf186bc))
* bump to v0.8.0 + modernized update notification ([acc90c7](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/acc90c72a17b7b7722fa8f913cfa453534ec4427))
* bump to v0.9.0 + changelog + fix flaky test ([c0973b1](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/c0973b10279dd38c88a1dd7d98564065344fd9f1))
* bump to v1.0.0 ([e8a2ba4](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/e8a2ba4e95b057fc4225f5130e2c17ad38f10c5f))
* bump version to v0.4.0 across all files + changelog ([aaa974b](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/aaa974ba1d7b1c977f08b3627683f2265e7bd024))
* bump version to v0.7.0 ([d2a0a60](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/d2a0a607b84d78a787c7871033f850305a1f421b))
* bump version to v1.5.1 ([45d4a24](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/45d4a24ab4b7f17ea12fac59d31ae1fd05561377))
* bump version to v1.5.2 ([06239a7](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/06239a7aad5a1167e19141393777025b6d506fc3))
* bump version to v1.5.3 ([1d7adfc](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/1d7adfccff8434a248e887dc6a488630a3e038dc))
* bump version to v1.6.1 ([bac99e2](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/bac99e2daddad180fa9d7bda0d2678726d1f20a9))
* code quality tuning — formatting, field ordering, precision constants ([1002e64](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/1002e64bb126b4486ee097137a8459e72dd3dd17))
* extend release integrity check to cover frontend + alembic env ([9fee719](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/9fee71986ae8ff25670b7615276e27f4d58be41e))
* **legal:** unify contact address across PRIVACY, COOKIES, TERMS ([5ae68bb](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/5ae68bbf332dc0ad53f1094d771ed796b98fc748))
* mark DWG Takeoff as BETA in sidebar ([64882e4](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/64882e4e6dc45565285ee24abcb97a5466aaa5f6))
* move CLAUDE.md to .claude/, add clean-ai-history script ([1bf5689](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/1bf56895d7bc6cf0ca47004f1a749657211e80d3))
* **readme:** remove Star History section ([c7ad728](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/c7ad7289b1f8e61917b9a146ecfbf72ae9fef967))
* release v1.6.0 — BIM integration, polyline takeoff, UI overhaul ([d645cfa](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/d645cfab815b4a34621672d4b1434c71466d0068))
* **release:** v2.4.0 — observability + i18n ([44f1ce1](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/44f1ce1d703a7874cac8016ca4c5e3f49fdc2aab))
* remove competitor product names from codebase ([e7b11ca](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/e7b11ca1e7fb6b3be39c01ee383eb9c375265b0d))
* **security:** strengthen SECURITY.md with CRA alignment and scope ([10fe999](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/10fe999c8f7adfd52a3ac4267a49572a1b9d7ec3))
* tech-debt sweep + legal cleanup + security bumps ([b481cab](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/b481cab01e56bff4fe5fa5d5d27be53ae8844ec2))
* trigger contributor cache refresh ([41d852a](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/41d852ada4a5084a6540873025b18a282c0885fa))
* v1.7.1 — deep quality polish across 57 files ([64f10a9](https://github.com/datadrivenconstruction/OpenConstructionERP/commit/64f10a97d602188592c294468241f2c8a10fab6f))
